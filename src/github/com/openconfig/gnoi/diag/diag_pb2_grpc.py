...
from github.com.openconfig.gnoi.diag import diag_pb2 as github_dot_com_dot_openconfig_dot_gnoi_dot_diag_dot_diag__pb2
...
class DiagStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StartBERT = channel.unary_unary(
                ...
                request_serializer=github_dot_com_dot_openconfig_dot_gnoi_dot_diag_dot_diag__pb2.StartBERTRequest.SerializeToString,
                response_deserializer=github_dot_com_dot_openconfig_dot_gnoi_dot_diag_dot_diag__pb2.StartBERTResponse.FromString,
                )
        self.StopBERT = channel.unary_unary(
                '/gnoi.diag.Diag/StopBERT',
                request_serializer=github_dot_com_dot_openconfig_dot_gnoi_dot_diag_dot_diag__pb2.StopBERTRequest.SerializeToString,
                response_deserializer=github_dot_com_dot_openconfig_dot_gnoi_dot_diag_dot_diag__pb2.StopBERTResponse.FromString,
                )
        self.GetBERTResult = channel.unary_unary(
                '/gnoi.diag.Diag/GetBERTResult',
                request_serializer=github_dot_com_dot_openconfig_dot_gnoi_dot_diag_dot_diag__pb2.GetBERTResultRequest.SerializeToString,
                response_deserializer=github_dot_com_dot_openconfig_dot_gnoi_dot_diag_dot_diag__pb2.GetBERTResultResponse.FromString,
                )
...
def add_DiagServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'StartBERT': grpc.unary_unary_rpc_method_handler(
                    servicer.StartBERT,
                    request_deserializer=github_dot_com_dot_openconfig_dot_gnoi_dot_diag_dot_diag__pb2.StartBERTRequest.FromString,
                    response_serializer=github_dot_com_dot_openconfig_dot_gnoi_dot_diag_dot_diag__pb2.StartBERTResponse.SerializeToString,
            ),
            'StopBERT': grpc.unary_unary_rpc_method_handler(
                    servicer.StopBERT,
                    request_deserializer=github_dot_com_dot_openconfig_dot_gnoi_dot_diag_dot_diag__pb2.StopBERTRequest.FromString,
                    response_serializer=github_dot_com_dot_openconfig_dot_gnoi_dot_diag_dot_diag__pb2.StopBERTResponse.SerializeToString,
            ),
            'GetBERTResult': grpc.unary_unary_rpc_method_handler(
                    servicer.GetBERTResult,
                    request_deserializer=github_dot_com_dot_openconfig_dot_gnoi_dot_diag_dot_diag__pb2.GetBERTResultRequest.FromString,
                    response_serializer=github_dot_com_dot_openconfig_dot_gnoi_dot_diag_dot_diag__pb2.GetBERTResultResponse.SerializeToString,
            ),
    }
...
class Diag(object):
    ...
    def StartBERT(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/gnoi.diag.Diag/StartBERT',
            github_dot_com_dot_openconfig_dot_gnoi_dot_diag_dot_diag__pb2.StartBERTRequest.SerializeToString,
            github_dot_com_dot_openconfig_dot_gnoi_dot_diag_dot_diag__pb2.StartBERTResponse.FromString,
    ...
    def StopBERT(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/gnoi.diag.Diag/StopBERT',
            github_dot_com_dot_openconfig_dot_gnoi_dot_diag_dot_diag__pb2.StopBERTRequest.SerializeToString,
            github_dot_com_dot_openconfig_dot_gnoi_dot_diag_dot_diag__pb2.StopBERTResponse.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetBERTResult(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/gnoi.diag.Diag/GetBERTResult',
            github_dot_com_dot_openconfig_dot_gnoi_dot_diag_dot_diag__pb2.GetBERTResultRequest.SerializeToString,
            github_dot_com_dot_openconfig_dot_gnoi_dot_diag_dot_diag__pb2.GetBERTResultResponse.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
