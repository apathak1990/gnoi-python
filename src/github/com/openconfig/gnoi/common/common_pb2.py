...
_REMOTEDOWNLOAD.fields_by_name['credentials'].message_type = github_dot_com_dot_openconfig_dot_gnoi_dot_types_dot_types__pb2._CREDENTIALS
...
RemoteDownload = _reflection.GeneratedProtocolMessageType('RemoteDownload', (_message.Message,), {
  ...
  '__module__' : 'github.com.openconfig.gnoi.common.common_pb2'
