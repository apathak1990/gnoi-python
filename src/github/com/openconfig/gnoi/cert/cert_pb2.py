...
RotateCertificateRequest = _reflection.GeneratedProtocolMessageType('RotateCertificateRequest', (_message.Message,), {
  ...
  '__module__' : 'github.com.openconfig.gnoi.cert.cert_pb2'
